...
CShader_3dapi_01_01::CShader_3dapi_01_01()
{
}
...
HRESULT CShader_3dapi_01_01::Create(LPDIRECT3DDEVICE9 pdev)
{
...
void CShader_3dapi_01_01::Release()
{
	if (m_pVertexShader)
	{
...
void CShader_3dapi_01_01::Render()
{
	if (m_pdev)
	{
...
void CShader_3dapi_01_01::Update()
{
	if (m_pdev)
	{
