...
CShader_3dapi_02_27::CShader_3dapi_02_27()
{
}
...
HRESULT CShader_3dapi_02_27::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	hr = D3DXCompileShaderFromFile("Ex02_27/Shader.fx"
		, NULL
		, NULL
		, "TxlPrc"
		, "tx_1_0"
...
void CShader_3dapi_02_27::Release()
{
	if (m_pTex)
	{
		m_pTex->Release();
...
void CShader_3dapi_02_27::Render()
{
	if (m_pdev)
	{
...
void CShader_3dapi_02_27::Update()
{
	if (m_pdev)
	{
