...
CShader_3dapi_03_18::CShader_3dapi_03_18()
{
}
...
HRESULT CShader_3dapi_03_18::Create(LPDIRECT3DDEVICE9 pdev)
{
	CBaseClass::Create(pdev);

	m_pShader = LoadShader("Ex03_18/Shader.fx");
	if (!m_pShader)
		return E_FAIL;
	...
	D3DXCreateTextureFromFile(m_pdev, "Ex03_18/wood.jpg", &m_pTex);

	m_pMesh = NULL;
	m_pMesh = new CMesh;
	m_pMesh->Create(m_pdev, "Ex03_18/teapot.x");

	return S_OK;
}

void CShader_3dapi_03_18::Release()
{
	if (m_pShader)
	{
		m_pShader->Release();
...
void CShader_3dapi_03_18::Render()
{
	if (m_pdev)
	{
		D3DXMATRIX mtView;
...
void CShader_3dapi_03_18::Update()
{
	if (m_pdev)
	{
		D3DXMATRIX mtScale;
