...
CShader_3dapi_01_25::CShader_3dapi_01_25()
{
}
...
HRESULT CShader_3dapi_01_25::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	hr = D3DXAssembleShaderFromFile("Ex01_25/Shader.vsh", NULL, NULL, dwFlags, &pShader, &pError);
...
void CShader_3dapi_01_25::Release()
{
	if (m_pVertexShader)
	{
...
void CShader_3dapi_01_25::Render()
{
	if (m_pdev)
	{
		D3DXMATRIX mtWorld;
...
void CShader_3dapi_01_25::Update()
{
	if (m_pdev)
	{
		static float c = 0.0f;
