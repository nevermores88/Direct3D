...
CShader_3dapi_02_25::CShader_3dapi_02_25()
{
}
...
HRESULT CShader_3dapi_02_25::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	hr = D3DXCompileShaderFromFile("Ex02_25/Shader.fx"
		, NULL
		, NULL
		, "TxlPrc"
		, "tx_1_0"
...
void CShader_3dapi_02_25::Release()
{
	if (m_pTex)
	{
		m_pTex->Release();
...
void CShader_3dapi_02_25::Render()
{
	if (m_pdev)
	{
...
void CShader_3dapi_02_25::Update()
{
	if (m_pdev)
	{
