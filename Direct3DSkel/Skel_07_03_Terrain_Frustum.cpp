...
CSkel_07_03_Terrain_Frustum::CSkel_07_03_Terrain_Frustum()
{
}
...
HRESULT CSkel_07_03_Terrain_Frustum::Create(LPDIRECT3DDEVICE9 pdev)
{
...
void CSkel_07_03_Terrain_Frustum::Release()
{
	if (m_pHeightTex)
	{
...
void CSkel_07_03_Terrain_Frustum::Render()
{
	if (m_pdev)
	{
...
void CSkel_07_03_Terrain_Frustum::Update()
{
	if (m_pdev)
	{
		SetupLights();
...
void CSkel_07_03_Terrain_Frustum::InitTexture()
{
	HRESULT hr = 0;
...
void CSkel_07_03_Terrain_Frustum::InitVertexBuffer()
{
	HRESULT hr = 0;
...
void CSkel_07_03_Terrain_Frustum::InitIndexBuffer()
{
...
void CSkel_07_03_Terrain_Frustum::SetupLights()
{
	D3DMATERIAL9	mtrl;
...
void CSkel_07_03_Terrain_Frustum::DrawMesh()
{
	if (m_pdev)
	{
...
void CSkel_07_03_Terrain_Frustum::ProcessMouse()
{
	POINT pt;
...
void CSkel_07_03_Terrain_Frustum::ProcessKey()
{
...
void CSkel_07_03_Terrain_Frustum::ProcessFrustumCull()
{
