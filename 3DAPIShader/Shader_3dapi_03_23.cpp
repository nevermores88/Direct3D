...
CShader_3dapi_03_23::CShader_3dapi_03_23()
{
}
...
HRESULT CShader_3dapi_03_23::Create(LPDIRECT3DDEVICE9 pdev)
{
	CBaseClass::Create(pdev);

	m_pShader = LoadShader("Ex03_23/Shader.fx");
	if (!m_pShader)
		return E_FAIL;
	...
	D3DXCreateTextureFromFile(m_pdev, "Ex03_23/Toon.png", &m_pToonTex);
	D3DXCreateTextureFromFile(m_pdev, "Ex03_23/wood.jpg", &m_pDiffuseTex);
...
void CShader_3dapi_03_23::Release()
{
	if (m_pShader)
	{
		m_pShader->Release();
...
void CShader_3dapi_03_23::Render()
{
	if (m_pdev)
	{
		D3DXMATRIX mtView;
		...
		m_pShader->SetTexture("g_ToonTex", m_pToonTex);
...
void CShader_3dapi_03_23::Update()
{
	if (m_pdev)
	{
		D3DXMATRIX mtScale;
