...
Shader_3dapi_03_24::Shader_3dapi_03_24()
{
}
...
HRESULT Shader_3dapi_03_24::Create(LPDIRECT3DDEVICE9 pdev)
{
...
void Shader_3dapi_03_24::Release()
{
	if (m_pShader)
	{
		m_pShader->Release();
...
void Shader_3dapi_03_24::Render()
{
	if (m_pdev)
	{
		float fHatchingWidth = 1.0f;
...
void Shader_3dapi_03_24::Update()
{
	if (m_pdev)
	{
		D3DXMATRIX mtScale;
