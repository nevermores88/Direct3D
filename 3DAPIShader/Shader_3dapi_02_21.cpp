...
CShader_3dapi_02_21::CShader_3dapi_02_21()
{
}
...
HRESULT CShader_3dapi_02_21::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	m_pShader = LoadPixelShader("Ex02_21/Shader.fx", &m_pConstTbl);
	if (!m_pShader)
		return E_FAIL;
...
void CShader_3dapi_02_21::Release()
{

}

void CShader_3dapi_02_21::Render()
{
	if (m_pdev)
	{
		//RenderScene();
...
void CShader_3dapi_02_21::Update()
{
	if (m_pdev)
	{
...
void CShader_3dapi_02_21::RenderScene()
{
	if (m_pdev)
	{
		D3DLIGHT9 d3Lght;
