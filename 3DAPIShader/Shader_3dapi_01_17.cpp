...
CShader_3dapi_01_17::CShader_3dapi_01_17()
{
}
...
HRESULT CShader_3dapi_01_17::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	hr = D3DXAssembleShaderFromFile("Ex01_17/Shader.vsh", NULL, NULL, dwFlags, &pShader, &pError);
	...
	D3DXCreateTextureFromFile(m_pdev, "Ex01_17/earth.bmp", &m_pTex);
...
void CShader_3dapi_01_17::Release()
{
	if (m_pVertexShader)
	{
...
void CShader_3dapi_01_17::Render()
{
	if (m_pdev)
	{
		D3DXMATRIX mtWorld;
...
void CShader_3dapi_01_17::Update()
{
	if (m_pdev)
	{
		static float c = 0.0f;
