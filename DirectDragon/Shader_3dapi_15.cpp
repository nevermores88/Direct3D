...
CShader_3dapi_15::CShader_3dapi_15()
{
}
...
void CShader_3dapi_15::Create(LPDIRECT3DDEVICE9 pdev, DWORD dwExType)
{
	m_dwExType = dwExType;
	m_pdev = pdev;
...
void CShader_3dapi_15::Release()
{

}

void CShader_3dapi_15::OnRender()
{
	if (m_pdev)
	{
...
void CShader_3dapi_15::OnUpdate()
{
	if (m_pdev)
	{
		D3DXMATRIX	mtY;
