...
CShader_3dapi_19_1::CShader_3dapi_19_1()
{
}
...
void CShader_3dapi_19_1::Create(LPDIRECT3DDEVICE9 pdev, DWORD dwExType)
{
	m_dwExType = dwExType;
	m_pdev = pdev;
	...
	hr = D3DXCompileShaderFromFile(
		L"Shader_3dapi_19/data/shader.fx",
		0, 0,
		"Main",
		"ps_2_0",
		D3DXSHADER_DEBUG,
...
void CShader_3dapi_19_1::Release()
{

}

void CShader_3dapi_19_1::OnRender()
{
	if (m_pdev)
	{
...
void CShader_3dapi_19_1::OnUpdate()
{
	if (m_pdev)
	{
		static float c = 0;
