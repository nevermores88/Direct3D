...
CShader_3dapi_05::CShader_3dapi_05()
{
}
...
void CShader_3dapi_05::Create(LPDIRECT3DDEVICE9 pdev, DWORD dwExType)
{
	m_dwExType = dwExType;
	m_pdev = pdev;
...
void CShader_3dapi_05::Release()
{

}

void CShader_3dapi_05::OnRender()
{
	if (m_pdev)
	{
...
void CShader_3dapi_05::OnUpdate()
{
