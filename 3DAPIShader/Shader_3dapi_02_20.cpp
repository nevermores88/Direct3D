...
CShader_3dapi_02_20::CShader_3dapi_02_20()
{
}
...
HRESULT CShader_3dapi_02_20::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	m_pShader = LoadPixelShader("Ex02_20/Shader.fx", &m_pConstTbl);
	if (!m_pShader)
		return E_FAIL;
...
void CShader_3dapi_02_20::Release()
{

}

void CShader_3dapi_02_20::Render()
{
	if (m_pdev)
	{
		//RenderScene();
...
void CShader_3dapi_02_20::Update()
{
	if (m_pdev)
	{
...
void CShader_3dapi_02_20::RenderScene()
{
	if (m_pdev)
	{
		D3DLIGHT9 d3Lght;
