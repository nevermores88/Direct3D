...
CShader_3dapi_22::CShader_3dapi_22()
{
}
...
void CShader_3dapi_22::Create(LPDIRECT3DDEVICE9 pdev, DWORD dwExType)
{
	m_dwExType = dwExType;
	m_pdev = pdev;
...
void CShader_3dapi_22::Release()
{

}

void CShader_3dapi_22::OnRender()
{
	if (m_pdev)
	{
...
void CShader_3dapi_22::OnUpdate()
{
	if (m_pdev)
	{
		static float c = 0;
