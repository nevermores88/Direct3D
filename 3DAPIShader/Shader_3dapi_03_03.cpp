...
CShader_3dapi_03_03::CShader_3dapi_03_03()
{
}
...
HRESULT CShader_3dapi_03_03::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	m_pShader = LoadShader("Ex03_03/Shader.fx");
	if (!m_pShader)
		return E_FAIL;

	m_pTex = LoadTexture("Ex03_03/earth.bmp");
	if (!m_pTex)
		return E_FAIL;
...
void CShader_3dapi_03_03::Release()
{
	if (m_pShader)
	{
		m_pShader->Release();
...
void CShader_3dapi_03_03::Render()
{
	if (m_pdev)
	{
		D3DXMATRIX mtView;
...
void CShader_3dapi_03_03::Update()
{
	if (m_pdev)
	{
		static float c = 0;
