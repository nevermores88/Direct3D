...
CShader_3dapi_13::CShader_3dapi_13()
{
}
...
void CShader_3dapi_13::Create(LPDIRECT3DDEVICE9 pdev, DWORD dwExType)
{
	m_dwExType = dwExType;
	m_pdev = pdev;
...
void CShader_3dapi_13::Release()
{

}

void CShader_3dapi_13::OnRender()
{
	if (m_pdev)
	{
...
void CShader_3dapi_13::OnUpdate()
{
	if (m_pdev)
	{
		D3DXMATRIX	mtY;
