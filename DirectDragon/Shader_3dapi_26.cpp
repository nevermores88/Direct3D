...
CShader_3dapi_26::CShader_3dapi_26()
{
}
...
void CShader_3dapi_26::Create(LPDIRECT3DDEVICE9 pdev, DWORD dwExType)
{
	m_dwExType = dwExType;
	m_pdev = pdev;
...
void CShader_3dapi_26::Release()
{

}

void CShader_3dapi_26::OnRender()
{
	if (m_pdev)
	{
...
void CShader_3dapi_26::OnUpdate()
{
