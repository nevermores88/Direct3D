...
CShader_3dapi_01_03::CShader_3dapi_01_03()
{
}
...
HRESULT CShader_3dapi_01_03::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	m_pVertices[0] = Vertex(-1, -1, 0, D3DXCOLOR(1, 0, 0, 1));
	m_pVertices[1] = Vertex(0, 1, 0, D3DXCOLOR(0, 1, 0, 1));
	m_pVertices[2] = Vertex(1, -1, 0, D3DXCOLOR(0, 0, 1, 1));
...
void CShader_3dapi_01_03::Release()
{
	if (m_pVertexShader)
	{
...
void CShader_3dapi_01_03::Render()
{
	if (m_pdev)
	{
...
void CShader_3dapi_01_03::Update()
{
	if (m_pdev)
	{
