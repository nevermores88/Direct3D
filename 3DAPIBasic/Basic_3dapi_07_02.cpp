...
CBasic_3dapi_07_02::CBasic_3dapi_07_02()
{
}
...
HRESULT CBasic_3dapi_07_02::Create(LPDIRECT3DDEVICE9 pdev)
{
	...
	D3DXCreateTextureFromFile(m_pdev, "Ex07_02/env3.tga", &m_pTex);

	return S_OK;
}

void CBasic_3dapi_07_02::Release()
{
	if (m_pTex)
	{
		m_pTex->Release();
...
void CBasic_3dapi_07_02::Render()
{
	if (m_pdev)
	{
...
void CBasic_3dapi_07_02::Update()
{
	if (m_pdev)
	{
