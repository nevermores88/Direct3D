...
CShader_3dapi_02::CShader_3dapi_02()
{
}
...
void CShader_3dapi_02::Create(LPDIRECT3DDEVICE9 pdev, DWORD dwExType)
{
	m_dwExType = dwExType;
	m_pdev = pdev;
...
void CShader_3dapi_02::Release()
{

}

void CShader_3dapi_02::OnRender()
{
	if (m_pdev)
	{
...
void CShader_3dapi_02::OnUpdate()
{
