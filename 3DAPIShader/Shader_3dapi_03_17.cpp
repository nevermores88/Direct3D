...
CShader_3dapi_03_17::CShader_3dapi_03_17()
{
}
...
HRESULT CShader_3dapi_03_17::Create(LPDIRECT3DDEVICE9 pdev)
{
	CBaseClass::Create(pdev);

	m_pShader = LoadShader("Ex03_17/Shader.fx");
	if (!m_pShader)
		return E_FAIL;
...
void CShader_3dapi_03_17::Release()
{
	if (m_pShader)
	{
		m_pShader->Release();
...
void CShader_3dapi_03_17::Render()
{
	if (m_pdev)
	{
		D3DXMATRIX mtView;
...
void CShader_3dapi_03_17::Update()
{
	if (m_pdev)
	{
		D3DXMATRIX mtScale;
